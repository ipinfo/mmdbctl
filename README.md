...
```bash
curl -Ls https://github.com/ipinfo/mmdbctl/releases/download/mmdbctl-1.2.0/macos.sh | sh
```

### Debian / Ubuntu (amd64)

```bash
curl -Ls https://github.com/ipinfo/mmdbctl/releases/download/mmdbctl-1.2.0/deb.sh | sh
```

OR

```bash
curl -LO https://github.com/ipinfo/mmdbctl/releases/download/mmdbctl-1.2.0/mmdbctl_1.2.0.deb
sudo dpkg -i mmdbctl_1.2.0.deb
```
...
```bash
iwr -useb https://github.com/ipinfo/mmdbctl/releases/download/mmdbctl-1.2.0/windows.ps1 | iex
```
...
curl -LO https://github.com/ipinfo/mmdbctl/releases/download/mmdbctl-1.2.0/mmdbctl_1.2.0_${PLAT}.tar.gz
# OR
wget https://github.com/ipinfo/mmdbctl/releases/download/mmdbctl-1.2.0/mmdbctl_1.2.0_${PLAT}.tar.gz
tar -xvf mmdbctl_1.2.0_${PLAT}.tar.gz
mv mmdbctl_1.2.0_${PLAT} /usr/local/bin/mmdbctl
```
